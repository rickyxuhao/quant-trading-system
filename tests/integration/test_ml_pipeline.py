...
class TestXGBoostModel:
    ...
    def test_model_initialization(self):
        """测试模型初始化"""
        model = XGBoostPricePredictor(lookback_window=20, prediction_horizon=5)
    ...
    def test_model_training(self):
        """测试模型训练"""
        model = XGBoostPricePredictor(
            lookback_window=10, prediction_horizon=1, n_estimators=10  # 减少树的数量加快测试
        )
    ...
    def test_prediction(self):
        """测试预测"""
        model = XGBoostPricePredictor(lookback_window=10, prediction_horizon=1, n_estimators=5)
...
class TestMLPipelineIntegration:
    ...
    def test_end_to_end_pipeline(self):
        ...
        # 2. 训练XGBoost模型
        xgb_model = XGBoostPricePredictor(lookback_window=20, prediction_horizon=1, n_estimators=10)
