...
def create_rolling_metrics_chart(
    ...
    # 滚动夏普 (简化计算)
    df['rolling_sharpe'] = (
        (df['daily_return'].rolling(window).mean() * 252 - 0.03) /
